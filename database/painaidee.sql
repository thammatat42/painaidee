...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 07:34 PM
...
CREATE TABLE `tb_comment` (
  ...
  `COMMENT_BY` varchar(140) NOT NULL,
  `COMMENT_DATE` datetime NOT NULL,
  `STATUS_CHG` int(11) NOT NULL
...
INSERT INTO `tb_comment` (`ID`, `NAME`, `EMAIL`, `IMG`, `MESSAGE`, `OWNER`, `COMMENT_BY`, `COMMENT_DATE`, `STATUS_CHG`) VALUES
(1, 'Make', 'test@hotmail.com', '20220405152786.jpg', 'ว้าวว สวยมากเลยสกลนครสักวันต้องไปให้ได้เลยยย คิดถึงวันหยุดจังเลย เเฮร่!', 'test@hotmail.com', 'test@hotmail.com', '2022-04-05 23:27:54', 0);
...
CREATE TABLE `tb_travel` (
  ...
  `IMG` varchar(1024) NOT NULL,
  `CREATE_BY` varchar(140) NOT NULL,
  `CREATE_DATE` datetime NOT NULL,
  `UPDATE_BY` varchar(140) NOT NULL,
...
INSERT INTO `tb_travel` (`ID`, `PROVINCE_ID`, `AMPHURES_ID`, `TOPIC`, `ABOUT`, `DETAIL`, `IMG`, `CREATE_BY`, `CREATE_DATE`, `UPDATE_BY`, `UPDATE_DATE`, `STATUS_CHG`) VALUES
(1, 35, 529, 'วัดพระธาตุเชิงชุม', 'สกลนคร เป็นจังหวัดที่ได้ชื่อว่าเป็นเมืองพุทธศาสน์ พระธาตุห้าแห่ง แหล่งอารยธรรมสามพันปี เนื่องจากมีประวัติศาสตร์อันยาวนานมีวัฒนธรรมและประเพณีดั้งเดิมที่ตกทอดกันรุ่นสู่รุ่นมาจากบรรพบุรุษตั้งแต่สมัยโบราณ', 'วัดพระธาตุเชิงชุม ตั้งอยู่ถนนเจริญเมือง อำเภอเมือง จังหวัดสกลนคร ในวัดพระธาตุเชิงชุมวรวิหาร  สร้างขึ้นเมื่อใดไม่ปรากฏหลักฐานชัด เป็นปูชนียสถานสำคัญคู่บ้านคู่เมืองสกลนครมาแต่โบราณ ภายในมีรอยพระพุทธบาท 4 พระองค์ นับเป็นดินแดนอันศักดิ์สิทธิ์ ดังคำกล่าวที่ว่า “จะมีครั้งไหนที่ได้อานิสงส์มากไปกว่าการได้มาบูชา พระธาตุที่สร้างครอบรอยพระบาทแห่งพระพุทธเจ้าถึง 4 พระองค์” เชื่อกันว่าอานิสงส์ในการนมัสการพระธาตุเชิงชุมจะก่อให้เกิดความ เป็นสิริมงคลสูงสุดแก่ตนเองและครอบครัวให้มีความเจริญรุ่งเรือง แคล้วคลาดปราศจากอันตราย รวมไปถึงการนมัสการหลวงพ่อพระองค์แสน ที่เชื่อกันว่าให้พรในด้านโชคลาภ ให้มีเงินทองนับหมื่นนับแสน มีความมั่งมีศรีสุขในชีวิต', '20220405327905.jpg', 'test@hotmail.com', '2022-04-05 22:45:47', '', '0000-00-00 00:00:00', 0),
(2, 35, 537, 'ฟาร์มฮัก Farm Hug  ', 'สกลนคร เป็นจังหวัดที่ได้ชื่อว่าเป็นเมืองพุทธศาสน์ พระธาตุห้าแห่ง แหล่งอารยธรรมสามพันปี เนื่องจากมีประวัติศาสตร์อันยาวนานมีวัฒนธรรมและประเพณีดั้งเดิมที่ตกทอดกันรุ่นสู่รุ่นมาจากบรรพบุรุษตั้งแต่สมัยโบราณ', 'ตั้งอยู่ที่ บ้านโพนยางคำ ตำบลโนนหอม อำเภอเมือง จังหวัดสกลนคร บริเวณถนนสกลนคร-นาแก  เป็นทั้งสถานที่ท่องเที่ยว  ร้านอาหาร ร้านกาแฟ  ฟาร์มแกะ  รวมกันอยู่ในแห่งเดียวกัน  ภายในฟาร์มมีร้านโคขุนคุณทองขายเต๊กเนื้อโคขุนโพนยางคำ รวมถึงอาหารประเภทต่างๆ เป็น จุดแวะพักแวะเที่ยว ที่จะได้สัมผัสบรรยากาศสไตล์คาวบอยคันทรี  ร่มรื่นด้วยการจัดตกแต่งสวนสวย  แถมมีมุมถ่ายภาพชิคๆ หลากหลายมุม', '20220406337348.jpg', 'test@hotmail.com', '2022-04-06 00:17:43', '', '0000-00-00 00:00:00', 0);
...
CREATE TABLE `tb_user` (
  ...
  `CREATE_DATE` datetime NOT NULL,
  `UPDATE_BY` varchar(240) NOT NULL,
  `UPDATE_DATE` datetime NOT NULL,
...
INSERT INTO `tb_user` (`ID`, `NAME`, `EMAIL`, `PASSWORD`, `IMG`, `TYPE`, `ABOUT_ME`, `STATUS_LOGIN`, `CREATE_BY`, `CREATE_DATE`, `UPDATE_BY`, `UPDATE_DATE`, `LOGIN_DATE`, `STATUS_CHG`, `COUNT_LIKE`, `COUNT_FOLLOW`, `COMMENT`) VALUES
(1, 'Make', 'test@hotmail.com', '25d55ad283aa400af464c76d713c07ad', '20220405152786.jpg', 'admin', 'I\'m beginner Programmer', 'Active', 'test', '2022-04-05 10:36:37', 'Make', '2022-04-05 21:57:40', '2022-04-05 23:16:49', 0, 0, 0, 0),
(2, 'make', 'make@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'no_img.jpg', 'user', '', 'Active', 'make', '2022-04-06 00:29:51', 'make@gmail.com', '2022-04-06 00:33:08', '2022-04-06 00:32:50', 0, 0, 0, 0);
